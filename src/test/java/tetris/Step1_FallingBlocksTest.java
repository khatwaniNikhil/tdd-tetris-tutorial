...
/**
 * 1. empty board().
 *              test toString show grid with dots hardcoded 3*3
 *              test hasFallingBlock
 * 2. drop a block, Board.drop(Block) - some hardcoded start loc(1st row, 2nd col)
 *              test hasFallingBlock
 *              test block.fallingOn
 *              test Board.toString
 * 3. Move the block, Board.tick() - for now move block vertically one pos down
 *              test hasFallingBlock
 *              test block.fallingOn
 *              test Board.toString
 * 4. Drop two blocks back 2 back - illegal stater
 * 5. Make 1st block reach to bottom using 3 ticks and then drop 2nd block followed by 2 ticks
 *              test board hasFalling true
 *              test board toString
 *              test block1.fallingOn, block2.fallingOn
 * 6. Make 1st block reach to bottom using 3 ticks and then drop 2nd block followed by 3 ticks, 2nd block stops at mid row.
 *              test board hasFalling false
 *              test board toString
 *              test block1.fallingOn, block2.fallingOn - same as above test case
 */
